...
`DatabaseRecord` is defined in [`database-types.ts`](../../../frontend/src/features/preview/database/database-types.ts).
...
Normalization is implemented in [`database-normalizers.ts`](../../../frontend/src/features/preview/database/database-normalizers.ts).
...
Filters are implemented in [`database-filters.ts`](../../../frontend/src/features/preview/database/database-filters.ts). A filter tree is a group with `and` or `or`, containing rules or nested groups.
...
Sorting is implemented in [`database-sorts.ts`](../../../frontend/src/features/preview/database/database-sorts.ts).
...
| --- | --- | --- |
| 1 | Build inferred attributes from records. | [`database-store.ts`](../../../frontend/src/features/preview/database/database-store.ts) |
| 2 | Merge explicit field definitions. | [`database-store.ts`](../../../frontend/src/features/preview/database/database-store.ts) |
| 3 | Normalize/evaluate field values and formulas. | [`database-normalizers.ts`](../../../frontend/src/features/preview/database/database-normalizers.ts), formula modules. |
| 4 | Resolve visible columns/properties. | [`database-store.ts`](../../../frontend/src/features/preview/database/database-store.ts) |
| 5 | Apply filter group and search query. | [`database-filters.ts`](../../../frontend/src/features/preview/database/database-filters.ts) |
| 6 | Apply sort rules. | [`database-sorts.ts`](../../../frontend/src/features/preview/database/database-sorts.ts) |
| 7 | Render active view. | [`features/preview/database/views/`](../../../frontend/src/features/preview/database/views) |
