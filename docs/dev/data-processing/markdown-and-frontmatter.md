...
Frontmatter is recognized only when it appears at the beginning of a Markdown document and is enclosed by `---` markers. The parser is implemented in [`features/preview/frontmatter.ts`](../../../frontend/src/features/preview/frontmatter.ts).
...
Database views can write back to Markdown frontmatter through [`frontmatter-update.ts`](../../../frontend/src/features/preview/database/frontmatter-update.ts).
...
| --- | --- |
| Change frontmatter parsing or serialization. | [`frontmatter.ts`](../../../frontend/src/features/preview/frontmatter.ts) and its tests. |
| Change how database cell edits update Markdown files. | [`frontmatter-update.ts`](../../../frontend/src/features/preview/database/frontmatter-update.ts). |
| Change block segmentation around database blocks. | [`markdownBlocks.ts`](../../../frontend/src/features/preview/markdownBlocks.ts) and [`databaseBlockSyntax.ts`](../../../frontend/src/lib/databaseBlockSyntax.ts). |
