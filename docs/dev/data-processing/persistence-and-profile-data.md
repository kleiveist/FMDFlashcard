...
The Rust backend resolves these under `app.path().app_data_dir()` in [`src-tauri/src/lib.rs`](https://github.com/kleiveist/FMDFlashcard/blob/main/apps/fmd-desktop/src-tauri/src/lib.rs).
...
Profile root resolution is implemented in [`lib/userVault.ts`](https://github.com/kleiveist/FMDFlashcard/blob/main/apps/fmd-desktop/src/lib/userVault.ts).
...
| --- | --- | --- |
| Profile root, active profile, migration. | [`features/user-vault/useUserVault.ts`](https://github.com/kleiveist/FMDFlashcard/blob/main/apps/fmd-desktop/src/features/user-vault/useUserVault.ts), [`features/user-vault/storage.ts`](https://github.com/kleiveist/FMDFlashcard/blob/main/apps/fmd-desktop/src/features/user-vault/storage.ts). | Bootstraps root, lists profiles, manages active profile, imports/exports. |
| Profile settings. | [`features/settings/useAppSettings.ts`](https://github.com/kleiveist/FMDFlashcard/blob/main/apps/fmd-desktop/src/features/settings/useAppSettings.ts). | Loads/saves app settings through profile context when available. |
