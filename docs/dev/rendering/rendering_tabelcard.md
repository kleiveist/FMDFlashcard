...
| Cloze <br>(drag tokens)                  | in the text: drag tokens: `tocken "token"`                             | ---  <br>#                                                | e-page <br>f-pages     | - UI: input fields for `tocken "token"` + drag/drop                                                                                                                                         | cd   |
| Cloze <br>(drag tokens)                  | in the text: drag tokens: `tocken "token"`<br>Typed blanks: `%%...%%` inside | ---  <br>#                                                | e-page <br>f-pages     | - UI: input fields for `tocken "token"` + drag/drop and  blanks: validation `%%...%%`                                                                                                       | cd   |
| Help/Hint block (optional)               | #help<br>                                                             | #helpend<br>---  <br>#                                    | e-page f-pages         | - Store content as **help/hint text** (not graded). - Parser removes the block before interaction detection (qa/tf/m1/m2/cl/cd/cld). - UI: render optionally (e.g., a “Show hint” toggle). | h    |
|                                          |                                                                       |                                                           |                        |                                                                                                                                                                                            |      |
