...
| Antwort-Marker (Q/A-Teil)               | Answer:{text}<br>Antwort: {text}                                     | ---  <br>#                                       | e-page <br>f-pages     | - Alles nach Marker als **Antworttext** speichern; Zeilenumbrüche beibehalten.                                                                                                                 | qa     |
...
| Cloze Lückentext:                       | -Typed blanks: `%...%` innerhalb                                   | ---  <br>#                                       | e-page <br>f-pages     | Validierung: jedes `%...%` enthält Text.                                                                                                                                                     | cl     |
| Cloze <br>Drag Tokens)                  | des Texts- Drag tokens: `"token"`                             | ---  <br>#                                       | e-page <br>f-pages     | - UI: Eingabefelder für `"token"` + Drag/Drop                                                                                                                                           | cd     |
| Cloze Lückentext +Drag Tokens           | Typed blanks: `%...%` + tokens: `"token"` innerhalb          | ---  <br>#                                       | e-page <br>f-pages     | - UI: Eingabefelder `"token"` und Drag/Drop<br> Token-Validierung: jedes `%...%`                                                                                                      | cld    |
| Help-/Hinweis-Block (optional)          | #help                                                                | #helpend<br>---  <br>#                           | e-page <br>f-pages     | - Inhalt als **Hinweis/Help-Text** speichern (nicht bewerten). - Parser entfernt Block vor Interaktions-Erkennung (qa/tf/m1/m2/cl/cd/cld). - UI: optional anzeigen (z. B. „Hinweis anzeigen“). | h      |
