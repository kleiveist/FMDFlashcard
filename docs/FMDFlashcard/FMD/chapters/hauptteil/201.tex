...
\item \textbf{Shell/Terminal:} Keine feste Shell-Vorgabe. Die Projektsteuerung erfolgt über plattformübergreifende \textbf{Python-Skripte}; eine interaktive Shell wird lediglich zum Aufruf der Befehle benötigt.
