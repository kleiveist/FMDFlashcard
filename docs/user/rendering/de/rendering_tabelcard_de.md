...
| Cloze <br>Drag Tokens)                  | des Texts- Drag tokens: `tocken "token"`                             | ---  <br>#                                       | e-page <br>f-pages     | - UI: Eingabefelder für `tocken "token"` + Drag/Drop                                                                                                                                           | cd     |
| Cloze Lückentext +Drag Tokens           | Typed blanks: `%%...%%` + tokens: `tocken "token"` innerhalb          | ---  <br>#                                       | e-page <br>f-pages     | - UI: Eingabefelder `tocken "token"` und Drag/Drop<br> Token-Validierung: jedes `%%...%%`                                                                                                      | cld    |
