...
export const clozeTypedEntry: SyntaxEntry = {
  ...
  detail: {
    en: {
      ...
      example: joinLines(["#card", "Fill in: The capital of France is %Paris%.", "#endcard"]),
      mistakes: ["Leaving an empty %...% segment.", "Forgetting to close a %...% marker."],
    },
    de: {
      whatItIs:
      ...
      mistakes: ["Leere %...%-Luecken lassen.", "%...%-Marker nicht schliessen."],
    },
  },
};
