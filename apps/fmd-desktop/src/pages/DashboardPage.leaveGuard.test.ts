...
const createMockAppState = ({
  ...
  ({
    ...
    userVault: {
      ...
      autoRootPath: "/vault/.profile",
      bootstrapProfileContext: vi.fn(async () => ({
        ok: true,
        profileRootPath: "/vault/.profile",
        profiles: [],
        activeProfileId: null,
        migrationWarning: null,
        resolvedRoot: "/vault/.profile",
      })),
      customPath: null,
      customRootPath: null,
      error: null,
      handleCreateProfile: vi.fn(async () => null),
      handleCustomPathChange: vi.fn(async () => undefined),
      handleExport: vi.fn(async () => undefined),
      handleImport: vi.fn(async () => undefined),
      handleModeChange: vi.fn(async () => undefined),
      handlePickCustomPath: vi.fn(async () => undefined),
      handleSelectProfile: vi.fn(async () => undefined),
      isBusy: false,
      migrationWarning: null,
      mode: "auto",
      profiles: [],
