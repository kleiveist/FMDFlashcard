...
export const CanvasPanel = ({
  ...
  const switchMode = useCallback(
    async (nextMode: CanvasMode) => {
      ...
      if (mode === "view" && nextMode === "edit") {
        ...
        draftDocumentRef.current = renderDocument;
      }
  ...
  const contextMenuNode = contextMenu?.nodeId
    ...
    : null;
  const canEdit = mode === "edit" && Boolean(selectedFile) && !isSaving;

  return (
    <section
      className="panel preview-panel canvas-panel business-canvas-editor"
