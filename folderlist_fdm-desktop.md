...
│   ├── 📄 NoteModal.test.tsx
│   ├── 📄 NoteModal.tsx
│   ├── 📄 PreviewPanel.interactions.test.ts
...
│   ├── 📄 StudyTimeBar.tsx
│   ├── 📄 UserToolsPanel.tsx
│   ├── 📄 UserVaultGateModals.tsx
│   ├── 📄 VaultCreateModal.tsx
│   ├── 📄 VaultDeleteModal.tsx
│   ├── 📄 VaultManagerModal.tsx
│   ├── 📄 VaultTree.test.ts
│   ├── 📄 VaultTree.tsx
│   └── 📄 icons.tsx
├── 📁 features
...
│   │   └── 📄 constants.ts
│   ├── 📁 flashcards
│   │   ├── 📄 filterFlashcardFiles.test.ts
│   │   ├── 📄 logic.test.ts
│   │   ├── 📄 logic.ts
│   │   ├── 📄 useFlashcardNoteFiles.ts
│   │   └── 📄 useFlashcards.ts
│   ├── 📁 preview
│   │   └── 📄 usePreview.ts
│   ├── 📁 settings
│   │   ├── 📄 normalizeSettings.test.ts
│   │   ├── 📄 settingsDeepLink.ts
│   │   ├── 📄 settingsNavigation.ts
│   │   ├── 📄 useAppSettings.ts
│   │   ├── 📄 validateExamSettings.test.ts
│   │   └── 📄 validateExamSettings.ts
│   ├── 📁 spaced-repetition
│   │   ├── 📄 logic.test.ts
│   │   ├── 📄 logic.ts
...
│   ├── 📄 flashcards.ts
│   ├── 📄 layoutMode.tsx
│   ├── 📄 markdownEditorColors.test.ts
│   ├── 📄 markdownEditorColors.ts
│   ├── 📄 markdownTables.ts
│   ├── 📄 path.test.ts
│   ├── 📄 path.ts
...
│   ├── 📄 types.ts
│   ├── 📄 useMediaQuery.ts
│   ├── 📄 useMobileSafeInput.test.ts
│   ├── 📄 useMobileSafeInput.test.tsx
│   ├── 📄 useMobileSafeInput.ts
│   ├── 📄 useTableView.ts
│   ├── 📄 userVault.test.ts
│   └── 📄 userVault.ts
├── 📁 pages
